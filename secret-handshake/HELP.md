...
You can submit your solution using the `exercism submit secret_handshake.c secret_handshake.h` command.
...
- The [C track's documentation](https://exercism.io/docs/tracks/c)
